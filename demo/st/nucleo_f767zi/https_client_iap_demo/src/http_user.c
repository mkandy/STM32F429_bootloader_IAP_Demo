...
#define APP_IMAGE_FILE "nucleo_f767zi_https_client_iap_blue_image" APP_IMAGE_VARIANT ".img"
#elif defined(APP_DEMO_BLUE)
#define APP_IMAGE_FILE "nucleo_f767zi_https_client_iap_red_image" APP_IMAGE_VARIANT ".img"
#else
#define APP_IMAGE_FILE "nucleo_f767zi_https_client_iap_green_image" APP_IMAGE_VARIANT ".img"
#endif
