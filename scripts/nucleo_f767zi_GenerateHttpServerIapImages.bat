...
SET "APP_IMAGE_BUILDER_DIR=..\utils\ApplicationImageBuilder"
...
SET SCN_1_OUTPUT=.\nucleo_f767zi_http_server_iap_image_scenario_1.img
...
SET SCN_2_OUTPUT=.\nucleo_f767zi_http_server_iap_image_scenario_2.img
...
SET SCN_3_OUTPUT=.\nucleo_f767zi_http_server_iap_image_scenario_3.img
...
echo -^> Generating 2 (Cipher App + Authentication) image...
