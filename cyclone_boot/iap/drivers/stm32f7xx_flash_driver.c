...
#include "iap/drivers/stm32f7xx_flash_driver.h"
#include "debug.h"

#define FLASH_BANK_SIZE 0x100000
#define FLASH_BANK1_ADDR ADDR_FLASH_SECTOR_0
#define FLASH_BANK2_ADDR ADDR_FLASH_SECTOR_12
...
//STM32F7xx flash driver private related functions
...
/**
 * @brief STM32F767ZI Flash driver
 **/
...
const FlashDriver flashDriver =
{
   ...
   },
   {
      ...
      {FLASH_SECTOR_8,  FLASH_SECTOR_8_SIZE,   FLASH_SECTOR_8_ADDR},
      {FLASH_SECTOR_9,  FLASH_SECTOR_9_SIZE,   FLASH_SECTOR_9_ADDR},
      {FLASH_SECTOR_10, FLASH_SECTOR_10_SIZE,  FLASH_SECTOR_10_ADDR},
      {FLASH_SECTOR_11, FLASH_SECTOR_11_SIZE,  FLASH_SECTOR_11_ADDR},
      ...
      {FLASH_SECTOR_20, FLASH_SECTOR_20_SIZE,  FLASH_SECTOR_20_ADDR},
      {FLASH_SECTOR_21, FLASH_SECTOR_21_SIZE,  FLASH_SECTOR_21_ADDR},
      {FLASH_SECTOR_22, FLASH_SECTOR_22_SIZE,  FLASH_SECTOR_22_ADDR},
      {FLASH_SECTOR_23, FLASH_SECTOR_23_SIZE,  FLASH_SECTOR_23_ADDR},
   }
};
...
error_t flashInit(void)
{
   ...
   //Debug message
   TRACE_INFO("Initializing STM32F7xx flash driver...\r\n");
   ...
   do
   {
      ...
      do
      {
         ...
         if(fCurrentBankID == FLASH_BANK_1_ID)
         {
            ...
            OBInit.BootAddr0  = __HAL_FLASH_CALC_BOOT_BASE_ADR(FLASH_BANK_2_ADDR);
            OBInit.BootAddr1  = __HAL_FLASH_CALC_BOOT_BASE_ADR(FLASH_BANK_1_ADDR);
         }
         ...
         else
         {
            ...
            OBInit.OptionType = OPTIONBYTE_BOOTADDR_0 | OPTIONBYTE_BOOTADDR_1;
            OBInit.BootAddr0  = __HAL_FLASH_CALC_BOOT_BASE_ADR(FLASH_BANK_1_ADDR);
            OBInit.BootAddr1  = __HAL_FLASH_CALC_BOOT_BASE_ADR(FLASH_BANK_2_ADDR);
         }
